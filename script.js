...
function inicializarWidgetDiario() {
    const curiosidades = [
        ...
        "Amazon Web Services controla 32% do mercado global de nuvem! ☁️",
        "Starlink tem mais de 5.000 satélites orbitando a Terra agora! 🛰️",
        "Cabo transatlântico GRACE HOPPER conecta EUA-Reino Unido-Espanha! 🌊",
        "Quantum internet vai permitir teletransporte de informação! ⚛️🚀",
        ...
        "Edge computing reduz latência processando dados próximo ao usuário! ⚡",
        "Um data center consome energia equivalente a 25.000 residências! 🏢⚡",
        "Protocolo HTTP/3 usa QUIC para conexões mais rápidas e seguras! 🚀",
        "Cabo submarino SEA-ME-WE 6 vai conectar França à Singapura! 🌏",
        "Fibra óptica resiste a interferência eletromagnética totalmente! 🛡️",
        "6G promete velocidades de 1 terabit por segundo até 2030! 🚀",
        "Internet2 conecta universidades a 400 gigabits por segundo! 🎓⚡",
        "Cabo PEACE conecta Europa, Ásia e África em 15.000km! 🌍",
        "Mesh networks criam redes autorreparáveis sem ponto central! 🕸️",
        "Fibra óptica pode detectar terremotos analisando vibrações! 🌍",
        "SD-WAN otimiza redes usando múltiplos links simultaneamente! 🔗",
        "Cabo 2Africa vai ser o maior do mundo: 45.000km ao todo! 🌍🥇",
        "WiFi 7 promete 46 gigabits por segundo - 4x mais rápido que WiFi 6! 📶",
        "Holografia quântica vai revolucionar videoconferências em 3D! 📹✨",
        "Cabos de fibra suportam temperatura de -55°C a +85°C! 🌡️",
        "Internet via satélite de baixa órbita tem latência de apenas 20ms! 🛰️",
        "Backbone brasileiro tem mais de 1 milhão de km de fibra! 🇧🇷",
        "ROADM permite reconfiguração óptica de redes automaticamente! 🔄",
        "Computação quântica vai quebrar criptografia atual em 15 anos! ⚛️🔐",
        "Cabo submarino mais profundo está a 8.000 metros no oceano! 🌊📏",
        "Machine Learning otimiza rotas de internet em tempo real! 🤖🛣️",
        "Fibra óptica biodegradável está sendo desenvolvida com açúcar! 🍃",
        "Internet industrial (IIoT) movimenta US$ 263 bilhões globalmente! 🏭💰",
        "Cabo Grace Hopper tem capacidade de 340 terabits por segundo! ⚡📊",
        "Redes neurais artificiais otimizam QoS de fibra óptica! 🧠⚡",
        "Cabo submarino mais longo tem 39.000km - quase uma volta na Terra! 🌍📏",
        "Internet tátil vai permitir cirurgias remotas com feedback! 👨‍⚕️🤖",
        "Photonic computing usa luz para processar dados - sem eletricidade! 💡💻",
        "Brasil é o 4º país com mais usuários de internet: 165 milhões! 🇧🇷🥉",
        "Cabo 2Africa custou US$ 1 bilhão - maior investimento em conectividade! 💰🌍",
        "Metamateriais vão criar fibras ópticas com propriedades impossíveis! 🔬✨",
        "Internet quântica de 4.600km já conecta Pequim a Xangai! 🇨🇳⚛️",
        "Cabo EllaLink conecta Europa à América Latina pela primeira vez diretamente! 🌎🌍"
    ];
